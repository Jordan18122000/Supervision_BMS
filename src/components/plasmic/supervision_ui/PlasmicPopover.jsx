...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: LoLK9HVqKHny/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: 2RGaYL0IFbFk/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__mq2Yk)}>
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__dTv1I)}
            label={"Open Popover"}
          />
        ),
