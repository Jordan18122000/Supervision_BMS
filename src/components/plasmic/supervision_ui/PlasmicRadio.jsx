...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: bO1zqe-W4Egq/css
...
function PlasmicRadio__RenderFunc(props) {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__qh8Kp)}>
        <div className={classNames(projectcss.all, sty.freeBox__cl8Ib)} />
      </div>
      {renderPlasmicSlot({
