...
import Label from "../../Label"; // plasmic-import: oZG5dj1wkNtC/component
import Radio from "../../Radio"; // plasmic-import: bO1zqe-W4Egq/component
import Description from "../../Description"; // plasmic-import: NA_hOn8-IjSe/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: sWXMCQynZyP7/css
...
function PlasmicRadioGroup__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__vw93T)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__mgNwP)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__kQqf)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__us3Ex)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
