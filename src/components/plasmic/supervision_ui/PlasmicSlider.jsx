...
import SliderThumb from "../../SliderThumb"; // plasmic-import: ZUF7G1hL7Yqs/component
...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: gP0kW2ReuBiN/css
  ...
  return (
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <div className={classNames(projectcss.all, sty.freeBox__fUcPs)}>
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__y3J4C)}>
        <div
